...
const NilaiUtama = () => {
  const values = [
    ...
    <path fill="#1F6F43" d="M471.3 6.7C477.7 .6 487-1.6 495.6 1.2 505.4 4.5 512 13.7 512 24l0 186.9c0 131.2-108.1 237.1-238.8 237.1-77 0-143.4-49.5-167.5-118.7-35.4 30.8-57.7 76.1-57.7 126.7 0 13.3-10.7 24-24 24S0 469.3 0 456C0 381.1 38.2 315.1 96.1 276.3 131.4 252.7 173.5 240 216 240l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0c-39.7 0-77.3 8.8-111 24.5 23.3-70 89.2-120.5 167-120.5 66.4 0 115.8-22.1 148.7-44 19.2-12.8 35.5-28.1 50.7-45.3z"/></svg>,
      title: "Keberlanjutan",
  ...
  return (
    <section className="py-16 bg-[#1F6F43]">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-white max-w-2xl mx-auto mb-12 font-lato font-bold">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-[#1F6F43] font-poppins mb-3">
                {value.title}
              </h3>
