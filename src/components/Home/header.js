  ...
  return (
    <Fade duration={2200}>
      <div className="max-w-7xl mx-auto lg:px-6 md:px-3">
        <div className=" my-5 mx-auto max-w-7xl px-4 sm:mt-4 sm:px-6 md:mt-6 lg:mt-8 lg:px-0 xl:mt-0 flex gap-10 lg:flex-justify lg:flex flex-col lg:flex-row flex-col-reverse">
          <div className="text-center lg:text-left flex flex-col justify-center">
            <h2 className="text-[#2e8b57] text-3xl font-bold xxs:text-2xl xs:text-3xl sm:text-5xl lg:text-6xl font-poppins">
              Narikela Recycle
            </h2>
            <h4 className="mt-2 text-lg sm:text-2xl md:text-3xl lg:text-2xl font-semibold font-montserrat text-[#8B4513]">
              Bersama Menciptakan Lingkaran Kebaikan.
            </h4>
            <p className="font-lato mt-3 text-base text-black-70 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-5xl lg:me-20">
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="rounded-md">
                <a
                  href="/contact"
                  className="font-poppins transition-all duration-500ms ease-in-out hover:ease-in-out w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-center bg-[#8B4513] text-white border border-[#8B4513] hover:text-[#8B4513] hover:border-[#C4A484] hover:bg-[#C4A484] md:text-lg md:px-10 "
                >
                  Jalin Kerja Sama
                  <svg
